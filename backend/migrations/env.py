...
# Ensure that the app directory is on the Python path
...
# *Fix: Explicitly set the database URL**
DATABASE_URL = os.getenv("DATABASE_URL", "postgresql://user:password@postgres:5432/dbname")
config.set_main_option("sqlalchemy.url", DATABASE_URL)  # Ensure Alembic gets the correct URL
